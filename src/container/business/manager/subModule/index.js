...
export default class SubModuleManagerIndex extends Component {
  static contextTypes = {
        ...
        },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='ModuleManager.SubModuleQuery.Edit'
                  type="primary"
  ...
  toDetailOrEdit = (record, type) => {
    let path = {
      pathname: `/manager/subModule/${type}`,
      state: {
              ...
              <TabPane tab="服务单元查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    deleteData={deleteSgSubmoduleCommonConfig}
                    deleteButtonId="ModuleManager.SubModuleQuery.BatchDelete"
                  />
                  <Table
