...
import { querySgModuleCommonConfigList, editSgModuleCommonConfig } from "../request/service";
...
class ModuleManagerEdit extends React.Component {
  static contextTypes = {
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        editSgModuleCommonConfig(data).then(res => {
          //返回信息
          this.setState({
            loading: false
          });
...
export default Form.create()(ModuleManagerEdit);
