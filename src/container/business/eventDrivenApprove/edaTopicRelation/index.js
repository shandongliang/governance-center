...
import {
  queryEdaTopicProducerRelationshipApproveList,
  deleteEdaTopicProducerRelationshipApprove,
...
export default class RelationApproveIndex extends Component {
  static contextTypes = {
        ...
        },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='EnventApprove.PRelationQuery.Edit'
                  type="primary"
  ...
  fetchData = () => {
    ...
    queryEdaTopicProducerRelationshipApproveList(data).then(res => {
      ...
      this.setState(
        {
          data: res.reply.result.resultList,
          pagination: page,
          loading: false
        },
        () => {
  ...
  toDetailOrEdit = (record, type) => {
    let path = {
      pathname: `/eventDrivenApprove/edaTopicRelation/${type}`,
      state: {
        id: record.id
      }
    }
    goTo(path,type === "detail"?"主题生产者关系详情":"主题生产者关系编辑");
  };
  // 获取筛选数据
              ...
              <TabPane tab="主题生产者关系查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    exportType="PRODUCER_RELATION"
                    deleteData={deleteEdaTopicProducerRelationshipApprove}
                    deleteButtonId="EnventApprove.PRelationQuery.BatchDelete"
                    exportOldButtonId="EnventApprove.PRelationQuery.ExportOldData"
                    exportButtonId="EnventApprove.PRelationQuery.ExportData"
                  />
                  <Table
