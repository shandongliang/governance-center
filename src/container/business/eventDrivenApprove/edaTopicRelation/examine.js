...
import {
  ...
  editEdaTopicProducerRelationshipApprove
} from "../request/service";
import { goTo, goToAndClose } from '../../../../util/tabRouter';
const FormItem = Form.Item;
const TabPane = Tabs.TabPane;
const confirm = Modal.confirm;
export default class RelationApproveExamine extends Component {
  static contextTypes = {
    ...
    return (
      <div style={{ position: "relative" }}>
        ...
        <ApproveModal
          ...
          approveData={editEdaTopicProducerRelationshipApprove}
          cancleModal={() => this.setState({ visible: false })}
        />
        <div className="pandora-main-content">
          <div className="tableWrap">
            <Tabs defaultActiveKey="1" style={{ marginBottom: 7 }}>
              <TabPane tab="主题生产者关系审核" key="1">
