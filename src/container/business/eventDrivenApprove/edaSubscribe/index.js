...
import {
  ...
  deleteEdaTopicSubscribeRelationshipApprove,
...
export default class SubscribeApproveIndex extends Component {
  static contextTypes = {
        ...
        },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='EnventApprove.CRelationQuery.Edit'
                  type="primary"
  ...
  toDetailOrEdit = (record, type) => {
    let path = {
      pathname: `/eventDrivenApprove/edaSubscribe/${type}`,
      state: {
        id: record.id
      }
    }
    goTo(path,type === "detail"?"订阅关系详情":"订阅关系编辑");
  };
  // 获取筛选数据
              ...
              <TabPane tab="订阅关系查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    exportType="SUBSCRIBE_RELATION"
                    deleteData={deleteEdaTopicSubscribeRelationshipApprove}
                    deleteButtonId="EnventApprove.CRelationQuery.BatchDelete"
                    exportOldButtonId="EnventApprove.CRelationQuery.ExportOldData"
                    exportButtonId="EnventApprove.CRelationQuery.ExportData"
                  />
                  <Table
