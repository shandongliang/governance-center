...
class SubscribeApproveEdit extends React.Component {
  static contextTypes = {
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        editEdaTopicSubscribeRelationshipApprove(data).then(res => {
          //返回信息
          this.setState({
            loading: false
          });
...
export default Form.create()(SubscribeApproveEdit);
