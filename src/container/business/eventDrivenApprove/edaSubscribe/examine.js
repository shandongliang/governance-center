...
import {
  ...
  editEdaTopicSubscribeRelationshipApprove
} from "../request/service";
import { goTo, goToAndClose } from '../../../../util/tabRouter';
const FormItem = Form.Item;
const TabPane = Tabs.TabPane;
const confirm = Modal.confirm;
export default class SubscribeApproveExamine extends Component {
  static contextTypes = {
    ...
    return (
      <div style={{ position: "relative" }}>
        ...
        <ApproveModal
          ...
          approveData={editEdaTopicSubscribeRelationshipApprove}
          cancleModal={() => this.setState({ visible: false })}
        />
        <div className="pandora-main-content">
          <div className="tableWrap">
            <Tabs defaultActiveKey="1" style={{ marginBottom: 7 }}>
              <TabPane tab="订阅关系审核" key="1">
