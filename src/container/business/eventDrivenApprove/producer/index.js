...
export default class ProducerApproveIndex extends Component {
  static contextTypes = {
        ...
        },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='EnventApprove.ProducerQuery.Edit'
                  type="primary"
              ...
              <TabPane tab="生产者查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    exportType="PRODUCER"
                    deleteData={deleteEdaTopicProducerApprove}
                    deleteButtonId="EnventApprove.ProducerQuery.BatchDelete"
                    exportOldButtonId="EnventApprove.ProducerQuery.ExportOldData"
                    exportButtonId="EnventApprove.ProducerQuery.ExportData"
                  />
                  <Table
