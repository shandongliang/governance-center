...
export default class TopicApproveIndex extends Component {
  static contextTypes = {
        ...
        },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='EnventApprove.TopicQuery.Edit'
                  type="primary"
  ...
  toDetailOrEdit = (record, type) => {
    let path = {
      pathname: `/eventDrivenApprove/topic/${type}`,
      state: {
        id: record.id
      }
    }
              ...
              <TabPane tab="主题查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    exportType="TOPIC"
                    deleteData={deleteEdaTopicApprove}
                    deleteButtonId="EnventApprove.TopicQuery.BatchDelete"
                    exportOldButtonId="EnventApprove.TopicQuery.ExportOldData"
                    exportButtonId="EnventApprove.TopicQuery.ExportData"
                  />
                  <Table
