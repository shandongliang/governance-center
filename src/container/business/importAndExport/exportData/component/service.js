...
import { serviceColumns } from "../../request/common";

const FormItem = Form.Item;
const TabPane = Tabs.TabPane;
const confirm = Modal.confirm;
export default class QueryServiceData extends Component {
  ...
  async componentDidMount() {
    const { serviceSelectedKey, serviceSelectedData } = this.props;
    await this.fetchData();
    this.setState({
      selectedRowKeys: serviceSelectedKey,
      selectedData: serviceSelectedData
    })
  }
  ...
  fetchData = () => {
    ...
    querySgServiceList(data).then(res => {
      ...
      this.setState(
        {
          data: res.reply.result.sgServiceList,
          pagination: page,
          loading: false
        },
        () => {
  ...
  changeStep = () => {
    ...
    this.props.getServiceData(selectedRowKeys, selectedData, "2");
  }
