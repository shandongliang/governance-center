...
export default class RelationIndex extends Component {
  static contextTypes = {
        ...
        // },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='EnventManager.PRelationQuery.Edit'
                  type="primary"
  ...
  toDetailOrEdit = (record, type) => {
    let path = {
      pathname: `/eventDriven/edaTopicRelation/${type}`,
      state: {
        id: record.id
      }
    }
              ...
              <TabPane tab="主题生产者关系查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    deleteData={deleteEdaTopicRelation}
                    deleteButtonId="EnventManager.PRelationQuery.BatchDelete"
                  />
                  <Table
