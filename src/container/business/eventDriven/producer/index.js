...
export default class ProducerIndex extends Component {
  static contextTypes = {
        ...
        // },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='EnventManager.ProducerQuery.Edit'
                  type="primary"
  ...
  fetchData = () => {
    ...
    queryEdaProducerList(data).then(res => {
      let page = Object.assign({}, this.state.pagination, {
        total: res.reply.producerList.page.total
      });
      this.setState(
        {
          data: res.reply.producerList.resultList,
          pagination: page,
          loading: false
        },
        () => {
  ...
  toDetailOrEdit = (record, type) => {
    let path = {
      pathname: `/eventDriven/producer/${type}`,
      state: {
        id: record.id
      }
    }
              ...
              <TabPane tab="生产者查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    deleteData={deleteEdaProducer}
                    deleteButtonId="EnventManager.ProducerQuery.BatchDelete"
                  />
                  <Table
