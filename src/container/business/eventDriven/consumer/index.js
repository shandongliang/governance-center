...
export default class ConsumerIndex extends Component {
  static contextTypes = {
        ...
        // },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='EnventManager.ConsumerQuery.Edit'
                  type="primary"
  ...
  fetchData = () => {
    ...
    queryEdaConsumerList(data).then(res => {
      let page = Object.assign({}, this.state.pagination, {
        total: res.reply.consumerList.page.total
      });
      this.setState(
        {
          data: res.reply.consumerList.resultList,
          pagination: page,
          loading: false
        },
        () => {
  ...
  toDetailOrEdit = (record, type) => {
    let path = {
      pathname: `/eventDriven/consumer/${type}`,
      state: {
        id: record.id
      }
    }
              ...
              <TabPane tab="消费者查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    deleteData={deleteEdaConsumer}
                    deleteButtonId="EnventManager.ConsumerQuery.BatchDelete"
                  />
                  <Table
