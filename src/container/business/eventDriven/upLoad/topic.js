...
class TopicFileUpload extends React.Component {
   ...
   uploadIE = (param) => {
       ...
       let option = {
           url: "/tesla-gateway-console-app/eda/importTopicExcel",
           type: "POST",
               ...
               <Spin spinning={this.state.uploading} >
                   ...
                   <Row style={{marginLeft:20}}>
                       <Col span={20} offset={1} style={{display:'block'}}> 
                           ...
                           {window.FormData?(
                               <FormItem className="file-upload" {...formItemLayout} label='主题文件上传'>
...
const WrapperFileUpload = Form.create()(TopicFileUpload);