...
class UploadFileUpload extends React.Component {
    ...
    uploadIE = (param, values) => {
        ...
        let option = {
            url: "/tesla-gateway-console-app/eda/importTxtByType",
            type: "POST",
            data: { ...param, val, reqSeqNo: reqSeqNo },
            dataType: "json",
            header: {},
                    ...
                    <Spin spinning={this.state.uploading} >
                        ...
                        <Row style={{ marginLeft: 20 }}>
                            <Col span={20} offset={1} style={{ display: 'block' }}>
                                ...
                                {window.FormData ? (
                                    <div>
                                        <FormItem hasFeedback {...formItemLayout} label='请选择类型：'
                                        >
                                            {getFieldDecorator('type', {
                                                ...
                                                <Select value={''}>
                                                    ...
                                                    <Option value="SUBSCRIBE">消费者订阅关系</Option>
