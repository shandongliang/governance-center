...
export default class ApproveRefresh extends Component {
    static contextTypes = {
    ...
    render() {
        ...
        return (
            <div className="approveRefresh">


                <Button type='primary' onClick={this.onSearch} style={{ height: '32px' }}>刷新权限缓存</Button>
                <Modal
