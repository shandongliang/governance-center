...
import {
  ...
  deleteSgModuleCommonConfigApprove,
...
export default class ModuleManagerApproveIndex extends Component {
  static contextTypes = {
        ...
        },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='ModuleManagerApprove.ModuleQuery.Edit'
                  type="primary"
  ...
  toDetailOrEdit = (record, type) => {
    let path = {
      pathname: `/managerApprove/module/${type}`,
      state: {
              ...
              <TabPane tab="模块查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    exportType="MODULENSERVICE"
                    deleteData={deleteSgModuleCommonConfigApprove}
                    deleteButtonId="ModuleManagerApprove.ModuleQuery.BatchDelete"
                    exportOldButtonId="ModuleManagerApprove.ModuleQuery.ExportOldData"
                    exportButtonId="ModuleManagerApprove.ModuleQuery.ExportData"
                  />
                  <Table
