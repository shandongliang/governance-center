...
import {
  ...
  editSgModuleCommonConfigApprove
} from "../request/service";
import { goTo, goToAndClose } from '../../../../util/tabRouter';
const FormItem = Form.Item;
const TabPane = Tabs.TabPane;
const confirm = Modal.confirm;
export default class ModuleManagerApproveExamine extends Component {
  static contextTypes = {
  ...
  approveData = (record, type) => {
    if(type==="single"){ //单个审核
      this.setState({
        selectedData: [{moduleId: record.moduleId}]
      })
    }
    this.setState({
      visible: true
    ...
    return (
      <div style={{ position: "relative" }}>
        ...
        <ApproveModal
          ...
          approveData={editSgModuleCommonConfigApprove}
