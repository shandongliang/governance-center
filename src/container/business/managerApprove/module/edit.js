...
import { querySgModuleCommonConfigApproveList, editSgModuleCommonConfigApprove } from "../request/service";
...
class ModuleManagerApproveEdit extends React.Component {
  static contextTypes = {
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        editSgModuleCommonConfigApprove(data).then(res => {
          //返回信息
          this.setState({
            loading: false
          });
...
export default Form.create()(ModuleManagerApproveEdit);
