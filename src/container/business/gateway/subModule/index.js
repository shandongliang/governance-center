...
import {
  ...
  deleteSgSubmoduleBusinessConfig,
  exportZkData
...
export default class SubModuleSgIndex extends Component {
  static contextTypes = {
        ...
        // },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='ServiceGovern.SubModuleQuery.Edit'
                  type="primary"
  ...
  toDetailOrEdit = (record, type) => {
    let path = {
      pathname: `/gateway/subModule/${type}`,
      state: {
        id: record.id
      }
    }
              ...
              <TabPane tab="服务单元查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    deleteData={deleteSgSubmoduleBusinessConfig}
                    deleteButtonId="ServiceGovern.SubModuleQuery.BatchDelete"
                  />
                  <Table
