...
export default class ServiceSgIndex extends Component {
  static contextTypes = {
        ...
        // },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='ServiceGovern.ServiceQuery.Edit'
                  type="primary"
              ...
              <TabPane tab="服务查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    deleteData={deleteSgServices}
                    deleteButtonId="ServiceGovern.ServiceQuery.BatchDelete"
                  />
                  <Table
