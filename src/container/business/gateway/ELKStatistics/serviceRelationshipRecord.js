...
import { queryServiceRelationshipDetailByElk } from "../requestA/service";
...
export default class ServiceRelationshipRecordStatistics extends Component {
  static contextTypes = {
  ...
  fetchData = () => {
    ...
    queryServiceRelationshipDetailByElk(data).then(res => {
      let page = Object.assign({}, this.state.pagination, {
        total: res.reply.page.total
      });
      this.setState(
        {
          data: res.reply.relationshipDetailList,
          pagination: page,
          loading: false
        },
        () => {
