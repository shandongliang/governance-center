...
import { queryServiceSubscribeDetailByElk, queryAllModuleListV1  } from "../requestA/service";
...
export default class SubscribeServiceRecord extends Component {
  static contextTypes = {
  ...
  fetchData = () => {
    ...
    queryServiceSubscribeDetailByElk(data).then(res => {
      let page = Object.assign({}, this.state.pagination, {
      ...
      this.setState(
        {
          data: res.reply.subscribeDetailList,
          ipPieData,
          modulePieData,
          pagination: page,
          loading: false
