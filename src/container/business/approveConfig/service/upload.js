...
import 'jqueryForm';
import { downloadServiceExcelTemplate, importServiceExcel, downloadServiceSimplifyExcelTemplate } from '../requestA/service'
...
export default class ExcelServiceUpload extends Component {
    static contextTypes = {
...
class ServiceExcelUpload extends React.Component {
    ...
    uploadIE = (param) => {
        ...
        let option = {
            url: "/tesla-approve-console-app/approve/importServiceExcel",
            type: "POST",
    ...
    uploadAntd = (param) => {
        ...
        importServiceExcel(formData).then(res => {
            let _this = this;           
    ...
    download = () => {
        downloadServiceExcelTemplate().then(res => {});
    }

    downloadSimple = () => {
      downloadServiceSimplifyExcelTemplate().then(res => {});
  }
...
const WrapperFileUpload = Form.create()(ServiceExcelUpload);