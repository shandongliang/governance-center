...
import {
  ...
  deleteSgModuleBusinessConfigApprove,
...
export default class ModuleApproveIndex extends Component {
  static contextTypes = {
              ...
              <TabPane tab="模块查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    exportType="MODULESERVICE"
                    deleteData={deleteSgModuleBusinessConfigApprove}
                    deleteButtonId="SgApprove.ModuleQuery.BatchDelete"
                    exportOldButtonId="SgApprove.ModuleQuery.ExportOldData"
                    exportButtonId="SgApprove.ModuleQuery.ExportData"
                  />
                  <Table
