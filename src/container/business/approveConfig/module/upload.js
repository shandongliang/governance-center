...
import 'jqueryForm';
import { downloadModuleExcelTemplate, importModuleExcel, downloadModuleSimplifyExcelTemplate } from '../requestA/service';
...
export default class ExcelModuleUpload extends Component {
    static contextTypes = {
...
class ModuleShipExcelUpload extends React.Component {
    ...
    uploadIE = (param) => {
        ...
        let option = {
            url: "/tesla-approve-console-app/approve/importServiceRelationshipExcel",
            type: "POST",
    ...
    uploadAntd = (param) => {
        ...
        importModuleExcel(formData).then(res => {
            let _this = this;           
    ...
    download = () => {
        downloadModuleExcelTemplate().then(res => {
        });
    }
    downloadSimple = () => {
      downloadModuleSimplifyExcelTemplate().then(res => {
      });
  }
    closeModal = () => {
        this.setState({
...
const WrapperFileUpload = Form.create()(ModuleShipExcelUpload);