...
import { querySgModuleBusinessConfigApproveList } from "../request/service";
...
class ModuleApproveDetail extends React.Component {
  static contextTypes = {
...
export default Form.create()(ModuleApproveDetail);
