...
import {
  ...
  deleteSgSubmoduleBusinessConfigApprove,
...
export default class SubModuleApproveIndex extends Component {
  static contextTypes = {
        ...
        },
        {
          ...
          render: (text, record, index) => {
            return (
              <div>
                <WrapButton
                  id='SgApprove.SubModuleQuery.Edit'
                  type="primary"
              ...
              <TabPane tab="模块查询" key="1">
                <div className="portlet-body">
                  ...
                  <ExportBtnGroup
                    ...
                    exportType="SERVICEUNIT"
                    deleteData={deleteSgSubmoduleBusinessConfigApprove}
                    deleteButtonId="SgApprove.SubModuleQuery.BatchDelete"
                    exportOldButtonId="SgApprove.SubModuleQuery.ExportOldData"
                    exportButtonId="SgApprove.SubModuleQuery.ExportData"
                  />
                  <Table
