...
export default class SubModuleContact extends Component {
  static contextTypes = {
  ...
  toDetailOrEdit = (record, type) => {
    let path = {
      pathname: "/approve/contact/subModuleContactEdit",
      state: {
...
class QueryForm extends React.Component {
  ...
  // 清空筛选框
  handleReset = () => {
    this.props.form.resetFields(["moduleCode", "subModuleCode"]);
    this.handleSearch();
  };
  // 查询筛选
  handleSearch = e => {
