                ...
                {List.map((text, index, record) => {
                  return (
                    <div>
                      <a
                        href="javascript:;"
                        onClick={this.toRelieve(text, index, record, val)}
                      >
                        删除
                      </a>
                    </div>
          ...
          render: (text, record, index) => {
            return (
              <div>
                <a
                  href="javascript:;"
                  onClick={() => this.toAdd(text, record, index)}
                >
                  新增
                </a>
              </div>
