...
angular.module('activitiModeler')
    .controller('StencilController', ['$rootScope', '$scope', '$http', '$modal', '$timeout', function ($rootScope, $scope, $http, $modal, $timeout) {
        ...
        $scope.editorFactory.promise.then(function () {
            ...
            /*
             StencilSet items 自定义 StencilSet，默认从后台获取
             */
            ...
            $http({method: 'GET', url: stencilUrl }).success(function (data, status, headers, config) {
                ...
                if(!hasCustomStencilsetFile) {
                  data = data.reply.result; // Tesla return format
                }              
